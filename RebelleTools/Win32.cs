...
namespace RebelleTools
{
    internal static class Win32
    {
        ...
        public static extern IntPtr SetWindowPos(IntPtr hWnd, HwndInsertAfter hWndInsertAfter, int x, int Y, int cx, int cy, SetWindowPosFlags wFlags);
